...
import UpdateProfile from './component/user/update_profile';
import ManageSite from './component/user/Admin/manage_site';
  ...
  return (
    <Layout>
      <Switch>
        ...
        <Route path='/user/site_info' exact component={Auth(ManageSite, true)}/>
